...
int main(int argc, char* argv[]) {
	...
	for (i=0 ; i < chip1_chr.size() ; i++) {
		...
		if (overlap == 0) {
			output.push_back(chip1_fullline[i]);
		}
	}
	...
	// Finally, write overlaps to output file
